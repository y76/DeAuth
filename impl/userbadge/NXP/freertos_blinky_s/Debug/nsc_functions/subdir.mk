...
C_SRCS += \
../nsc_functions/nsc_functions.c 

C_DEPS += \
./nsc_functions/nsc_functions.d 

OBJS += \
./nsc_functions/nsc_functions.o 


# Each subdirectory must supply rules for building sources it contributes
nsc_functions/%.o: ../nsc_functions/%.c nsc_functions/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-nsc_functions

clean-nsc_functions:
	-$(RM) ./nsc_functions/nsc_functions.d ./nsc_functions/nsc_functions.o

.PHONY: clean-nsc_functions
